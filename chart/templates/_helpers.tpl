...
{{ include "s3-viewer.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "s3-viewer.selectorLabels" -}}
...
*/}}
{{- define "s3-viewer.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "s3-viewer.fullname" .) .Values.serviceAccount.name }}
{{- else }}
